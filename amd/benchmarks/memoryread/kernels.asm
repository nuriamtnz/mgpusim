	...
	.protected	vectorRead      ; -- Begin function vectorRead
	.globl	vectorRead
	.p2align	8
	.type	vectorRead,@function
	.amdgpu_hsa_kernel vectorRead
...
; %bb.0:
	...
	s_endpgm
.Lfunc_end0:
	.size	vectorRead, .Lfunc_end0-vectorRead
                                        ; -- End function
